    ...
    return(
        <div className="section-wrapper">
            ...
            <div className="products-grid">
                <CardWithButton onAdd={onAdd} name_img = {rafCoffee}  alt_={"rafCoffee"} title={"Раф-кофе"} price={7.00} description={"Популярный напиток, где эспрессо взбивается вместе со сливками и ванильным сахаром. Имеет нежную консистенцию подтаявшего мороженого."}/>
                <CardWithButton onAdd={onAdd} name_img = {bumblebeeCoffee}  alt_={"bumblebeeCoffee"} title={"Бамбл-кофе"} price={6.80} description={"Освежающий многослойный коктейль из льда, карамельного сиропа, свежевыжатого апельсинового сока и порции эспрессо."}/>
