    ...
    return(
        <div className="section-wrapper">
            ...
            <div className="products-grid">
                ...
                <CardWithButton onAdd={onAdd} name_img = {icedVanillaLatte}  alt_={"icedVanillaLatte"} title={"Айс ванильный латте"} price={6.80} description={"Охлаждённый эспрессо с молоком, льдом и нашим мягким ванильным сиропом."} />
                <CardWithButton onAdd={onAdd} name_img = {ColdBrewWithSweetCream}  alt_={"eColdBrewWithSweetCream"} title={"Колд брю со сладкими сливками"} price={7.40} description={"Наш классический колд брю с шапкой из домашних ванильных сливок."}/>
                ...
                <CardWithButton onAdd={onAdd} name_img = {espressoShakenWithBrownSugar}  alt_={"espressoShakenWithBrownSugar"} title={"Шейкен эспрессо с коричневым сахаром"} price={6.40} description={"Эспрессо, взбитый со льдом и коричневым сахаром, для освежающего вкуса."}/>
