    ...
    return(
        <div className="section-wrapper">
            ...
            <div className="products-grid">
                ...
                <CardWithButton onAdd={onAdd} name_img = {chocolateChipCookies}  alt_={"dchocolateChipCookies"} title={"Печенье с шоколадом"} price={1.00} description={"Печенье на коричневом масле с шоколадом и щепоткой морской соли."}/>
