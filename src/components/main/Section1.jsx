/**
 * Section1.jsx — hero-блок главной: заголовок, текст, две кнопки, справа (на десктопе) картинка.
 * Импорт SVG=
 */
...
/**
 * @param {function} onMenuClick — передано из Layout: переключить view на меню
 * @param {function} onOrderClick — передано из Layout: переключить view на страницу заказа
 */
      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            {/* onClick вызывает функцию из пропсов без аргументов */}
